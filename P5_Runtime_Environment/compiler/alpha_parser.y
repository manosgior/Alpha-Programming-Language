...
%type  <stmtInfoValue>		forstmt
%type  <stmtInfoValue> 		whilestmt
%type  <unsignedValue>      whilestart
%type  <unsignedValue>      whilecond
%type  <stmtInfoValue>		returnstmt
...
funcdef:		N funcprefix LEFT_PAREN idlist RIGHT_PAREN block { 
					$$ = Manage_funcdef_N_funcprefix_LEFT_PAREN_idlist_RIGHT_PAREN_block($1, $2, $6); 
					backToPreviousTmpVarSpace();
					}
				;

funcprefix:		FUNCTION funcname { 
					$$ = Manage_funcprefix_FUNCTION_funcname($2); 
					createNewTmpVarSpace();
					}
				;
